...
o	Una cadena que queremos buscar (A)
o	Una segunda cadena (B) en la que queremos buscar la segunda cadena.
...
•	No debe tener en cuenta mayúsculas o minúsculas.
	...
	sea necesario hasta que no se encuentre. Para esto, nos ayudará la sobrecarga del método indexOf 
	que recibe dos parámetros.
Recuerda que una sobrecarga es una versión distinta de un método que hace un trabajo igual o similar, pero 
que recibe distintos parámetros.
Ejemplos:
